...
const Navbar = () => {
    ...
    // Lock body and html scrolling when the mobile menu is open
    useEffect(() => {
        if (isOpen) {
    ...
    return (
        <>
            <nav className={`navbar ${isScrolled ? 'scrolled' : ''} ${isOpen ? 'menu-is-open' : ''}`} id="navbar">
            ...
            {/* Overlay backdrop for mobile menu, placed outside the navbar container */}
